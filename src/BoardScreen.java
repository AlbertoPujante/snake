...
public class BoardScreen extends JPanel {
    ...
    public BoardScreen(MainWindow mw) {
        ...
        extraInfo = J_LABEL_EXTRA_INFO;

        success = J_LABEL_SUCCESS;
        ...
        roll = J_BUTTON_TIRADA;
        roll.addActionListener(Tirada());
        roll.setVisible(true);

        stats.add(roll);

        dieResults = J_LABEL_EXTRA_INFO;
    ...
    private static final JButton J_BUTTON_NEW_GAME = new JButton("New Game");
